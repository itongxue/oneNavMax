...
$theme_config =  [
  ...
  [
    ...
    'name' => 'lytoday',
    'title' => '今日热榜',
    'description' => 'LyToday-JS插件显示位置，每日免费请求上限200次<a href="https://doc.lylme.com/spage/#/lytoday-js" target="_blank">文档</a>',
    "value" => 0,
    'enum' => [
      0 => "关闭",
      1 => "搜索栏下方",
  ...
  [
    'type' => 'select',
    'name' => 'group_font_weight',
    'title' => '分组名称字体粗组',
    'description' => '链接名称字体粗组',
    "value" => "normal",
    'enum' => [
      'lighter' => "细体",
      'normal' => "正常",
